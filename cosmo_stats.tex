...
En este art\'iculo revisaremos los fundamentos b\'asicos de 
la Cosmolog\'ia de alta precisi\'on. Para esto, en las secciones (\ref{sec:Universo}) y (\ref{sec:Geom}) 
 introduccimos las ecuaciones b\'asicas que rigen la din\'amica de nuestro Universo y 
la geometr\'ia al que \'este debe necesariamente estar sujeto. Posteriormente, en la secci\'on 
(\ref{sec:Inven}) nos enfocaremos en describir los diferentes constituyentes de materia que nuestro Universo 
puede contener. De \'esta manera, en la secci\'on (\ref{sec:eqns}) utilizaremos esta informaci\'on los 
resultados para as\'i obtener las ecuaciones finales que describen la din\'amica de nuestro Cosmos. 
Como es de esperarse, cualquier 
teor\'ia f\'isica que est\'e sujeta a observaciones experimentales por tanto contenga cantidades observables, en la 
secci\'on (\ref{sec:Params}) describimos los par\'ametros cosmol\'ogicos que nos ayudar\'an a poder 
comprobar nuestras teor\'ias. Luego, en la secci\'on (\ref{sec:Observ}) describiremos uno de los experimentos 
cl\'asicos que nos permiten hacer fuertes constricciones sobre los par\'ametros de densidad y 
curvatura en nuestro Cosmos. Uno vez que ya tenemos nuestro conjunto de par\'ametros observables 
y resultados observacionales, es preciso tener un m\'etodo de an\'alisis de dichos resultados. 
Para esto, y debido a la naturaleza de nuestras observaciones (no podemos generar m\'ultiples 
Universos para hacer observaciones), en la secci\'on (\ref{sec:Bayes}) damos un peque\~no repaso a la 
estad\'istica Bayesiana, la cual nos permitir\'a hacer esta tarea. En este art\'iculo solamente nos 
centraremos en la inferencia de par\'ametros, por lo que esta introducci\'on se har\'a de tal forma 
de que el objetivo pueda ser alcanzado. En la Cosmolog\'ia estandar se suelen tener teor\'ias 
con varios par\'ametros, por lo que la realizaci\'on anal\'itica de nuestro an\'alisis no es 
usualmente posible. Para esto, en la secci\'on (\ref{ref:metodos}) nos enfocaremos en proporcionar las 
herramientas computacionales b\'asicas que nos permitir\'an hacer nuestra inferencia de par\'ametros 
de forma num\'erica. Finalmente aplicaremos todos estos nuevos conceptos 
aprendidos en uno de los ejemplos m\'as simples que existen: ajustar los par\'ametros libres de una recta (\ref{sec:recta})
y distancias lumin\'osas (\ref{sec:SNs}).
...
de fuentes lejanas medida por lentes gravitacionales.
 Una discuci\'on extensa sobre el estado de la materia oscura, incluyendo evidencia experimental
...
Para realizar una comparaci\'on cuantitativa entre modulo de la distancia medido por diversas supernovas con la 
distancia lumin\'osa te\'orica hacemos uso del c\'odico \texttt{SimpleMC} desarrollado por A. Slosar y J.A. V\'azquez 
 \cite{simplemc}. \'Este permite comprimir la informaci\'on de 
...
a partir de Supernovas y agregando datos obtenidos por el sat\'elite Planck $\Omega_{DM} =0.30 \pm 0.04$, 
...
$\Omega_k = -0.003 \pm 0.003$, donde el error en ambas combinaciones representa el 68\% nivel de confianza.
...
\bibitem{jav} A V\'azquez-González, T Matos, Revista mexicana de F\'isica E, 2008
\bibitem{LicV2} Verde L., astroph/0712.3028 (2007)
\bibitem{AlanH}{Alan Heaven} Alan Heavens; Statistical techniques in cosmology; May 2010
